...
int lWriteText(coor startPoint, string texty, int lineLength, int fontSize=0); //prints @texty using multiple lines, its ULC is given (@startPoint), 0 fontSize means no font change, cannot handle "too long" words
